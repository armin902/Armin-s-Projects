public class World_Campus implements Students
{
    private String name;
    ...
    public World_Campus(String name, String email, int ID, boolean attendingZoom, boolean attendingInPerson, int gradeAverage)
    {
        this.name = name;
        this.email = email;
        this.ID = ID;
