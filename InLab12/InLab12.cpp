...
int CountSmaller5(BinNode* root)
{
	...
	return counter + CountSmaller5(root->left) + CountSmaller5(root->right);
}
...
int main() {
	...
	root = NULL; // Empty BST
	cout << "Total Number of leaves: " << CountLeaves(root) << endl;
	cout << "Total Number of Nodes with Value <= 5: " << CountSmaller5(root) <<
	endl;
	cout << "Smallest Value in BST: " << FindMin(root) << endl;
	cout << "============================================================" << endl;
	...
	endl;
	cout << "Smallest Value in BST: " << FindMin(root) << endl;
	DeleteTree(root);  // Comment this line for additional tests for your function
}
