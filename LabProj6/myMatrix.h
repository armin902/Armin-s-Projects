...
// Name: <Armin Rejaie>
// Section: <001>
// Assignment: LabProj6 myMatrix.h
//
...
public:
	...
	// Initialize the matrix of given height and width with elements from a givenarray
	...
	myMatrix operator+=(myMatrix& matrixToConcatenate);
